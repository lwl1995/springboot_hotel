...
<body>
	...
	<form action="<%=basePath%>/updateVipInfo.do" method="post">
		<div class="formbody">
				...
				<div id="tab1" class="tabson">
					...
					<ul class="forminfo">
						<input name="id" type="hidden" class="dfinput"
							value="${vipInfoMap.id }" id="name" />
						</li>

						<li><label>会员卡号<b>*</b></label> <input name="vipNum"
							type="text" class="dfinput" value="${vipInfoMap.vip_num }"
							id="name" /></li>

						<li><label>会员姓名<b>*</b></label> <input name="customerName"
							type="text" class="dfinput" value="${vipInfoMap.customer_name }"
							id="name" /></li>

						<li><label>性别<b>*</b></label> <input name="gender"
							type="text" class="dfinput"
							value="${vipInfoMap.gender==1?'男':'女' }" id="name" /></li>

						<li>
							<div style="position: relative">
								<label>身份证号码<b>*</b></label> <input name="idcard"
									value="${vipInfoMap.idcard }" type="text" class="dfinput"
									onblur="checkidentity()" id="identity" />
							</div>
							<div id="notice2"
						...
						<li>
							<div>
								<label>手机号码<b>*</b></label> <input name="phone" type="text"
									class="dfinput" value="${vipInfoMap.phone }"
									onblur="checkphone()" />
							</div>
							<div id="notice3"
								style="font-size: 14px; color: red; position: absolute; z-index: 1000; margin-top: -30px; margin-left: 450px">
