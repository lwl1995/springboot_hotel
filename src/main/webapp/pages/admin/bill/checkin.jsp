    ...
    <form action="<%=basePath %>/addInRoomInfo.do" method="post">
      <ul class="forminfo">
        ...
        <li  style="margin-top:20px;">
          ...
          <div class="vocation">
            <input name="customerName" required="required" pattern=".{2,20}" type="text" class="dfinput" placeholder="长度为2-20位字符" value="${errorMap.customerName==null?inRoomInfo.customerName:'' }" style="width:344px;"/>
          <span>${errorMap.customerName==null?'':inRoomInfo.customerName }</span>
          </div>
        </li>
        <br />
        <li>
        ...
        <br />
        <li><cite>
          <label for="sex">会员<b>*</b></label>    <!-- 1代表是会员 0代表不是会员 -->
        ...
        <li>
          ...
          <div class="vocation">
            <input name="idcard" type="text" required="required" pattern="\d{17}[0-9X]" class="dfinput" placeholder="请填写客户身份证号码" value="${errorMap.idcard==null?inRoomInfo.idcard:'' }" style="width:344px;"/>
          </div>
        </li>
        <br />
        <li>
          ...
          <div class="vocation">
            <input name="phone" required="required" pattern="1[35789]\d{9}" type="text" class="dfinput" placeholder="请填写客户手机号码" value="${errorMap.phone==null?inRoomInfo.phone:'' }" style="width:344px;"/>
          </div>
        </li>
        <br />
       <%--  <li>
          ...
          <div class="vocation">
            <input name="money" required="required" pattern="[1-9]\d*|0" type="text" class="dfinput" placeholder="输入押金金额" value="${errorMap.money==null?inRoomInfo.money:'' }" style="width:344px;"/>
          </div>
        </li>
        <br /> --%>
        <li>
