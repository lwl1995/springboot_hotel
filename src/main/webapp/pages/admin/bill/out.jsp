	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			<div id="tab1" class="tabson">
				<form id="form1" action="<%=basePath %>/getInRoomInfo.do">
				<ul class="forminfo">
					<li>
						<label>房间号<b>*</b></label>
						<div class="vocation">
					...
					<li style="margin-top: 20px;"><label for="name">客人姓名<b>*</b></label>
						<div class="vocation">
							<input name="customerName" type="text" class="dfinput" value="${map.customerName }"
								style="width: 344px;" />
						</div></li>
					<br />
					<br />
					<li><label for="price" style="cursor: pointer">单价<b>*</b></label>
						<div class="vocation">
							<input name="price" id="price" class="dfinput" value="${map.price }"
								style="width: 344px;" />
						</div></li>
					<br />
					<li><label for="yajin" style="cursor: pointer">押金<b>*</b></label>
						<div class="vocation">
							<input name="yajin" id="yajin" type="text" class="dfinput"
								value="${map.money }" style="width: 344px;" />
						</div></li>
					<br />
		...
		$("select[name=roomId]").change(function(){
			...
			$.ajax({
				...
				success:function(result){
					...
					$("input[name=qita]").val(otherMoney);
