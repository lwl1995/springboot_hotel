...
<div class="formbody">
  ...
  <div id="usual1" class="usual">
    ...
    <form action="<%=basePath %>/addRoomsInfo.do" method="post">
      <ul class="forminfo">
      <li>
          <div class="vocation"> 
        ...
        <br />
       <!--  <li>
        	<input name="roomStatus" type="hidden" value="1"
									class="laydate-icon span1-1" id="Calendar"
									style="width: 324px; height: 30px; line-height: 28px; text-indent: 10px;" />
        </li>
        <br> -->
        <li>
        	<input name="room_type_id" type="hidden" value="1"
									class="laydate-icon span1-1" id="Calendar"
									style="width: 324px; height: 30px; line-height: 28px; text-indent: 10px;" />
        </li>
        <br>
